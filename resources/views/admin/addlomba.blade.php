                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Nama" name="namalomba" id="namalomba">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="tingkat">Tingkat</label>
                            <input type="text" class="form-control" placeholder="Tingkat" name="tingkat" id="tingkat">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
